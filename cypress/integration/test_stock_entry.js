context('Create Stock Entry', () => {
    ...
    cy.login();
			...
			//Set purpose
			cy.get_field('stock_entry_type', 'Link').type('Material Request{downarrow}{enter}', { force: true })
			cy.get_field('stock_entry_type', 'Link').should('have.value', 'Material Request');
